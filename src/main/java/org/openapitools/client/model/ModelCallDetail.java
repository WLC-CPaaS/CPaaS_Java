  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelCallDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelCallDetail is not found in the empty JSON string", ModelCallDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelCallDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelCallDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("call_duration") != null && !jsonObj.get("call_duration").isJsonNull()) && !jsonObj.get("call_duration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `call_duration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("call_duration").toString()));
      }
      ...
      if ((jsonObj.get("call_time") != null && !jsonObj.get("call_time").isJsonNull()) && !jsonObj.get("call_time").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `call_time` to be a primitive type in the JSON string but got `%s`", jsonObj.get("call_time").toString()));
      }
      ...
      if ((jsonObj.get("callee_number") != null && !jsonObj.get("callee_number").isJsonNull()) && !jsonObj.get("callee_number").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `callee_number` to be a primitive type in the JSON string but got `%s`", jsonObj.get("callee_number").toString()));
      }
      ...
      if ((jsonObj.get("caller_number") != null && !jsonObj.get("caller_number").isJsonNull()) && !jsonObj.get("caller_number").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `caller_number` to be a primitive type in the JSON string but got `%s`", jsonObj.get("caller_number").toString()));
      }
