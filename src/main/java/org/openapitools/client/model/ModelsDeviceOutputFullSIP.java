...
public class ModelsDeviceOutputFullSIP {
  ...
  public ModelsDeviceOutputFullSIP() {
  }

  public ModelsDeviceOutputFullSIP inviteFormat(@javax.annotation.Nullable String inviteFormat) {
  ...
  public void setInviteFormat(@javax.annotation.Nullable String inviteFormat) {
    this.inviteFormat = inviteFormat;
  }


  public ModelsDeviceOutputFullSIP password(@javax.annotation.Nullable String password) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsDeviceOutputFullSIP
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsDeviceOutputFullSIP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsDeviceOutputFullSIP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsDeviceOutputFullSIP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsDeviceOutputFullSIP.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsDeviceOutputFullSIP>() {
           @Override
           public void write(JsonWriter out, ModelsDeviceOutputFullSIP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsDeviceOutputFullSIP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsDeviceOutputFullSIP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsDeviceOutputFullSIP
   * @throws IOException if the JSON string is invalid with respect to ModelsDeviceOutputFullSIP
   */
  public static ModelsDeviceOutputFullSIP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsDeviceOutputFullSIP.class);
  }

  /**
   * Convert an instance of ModelsDeviceOutputFullSIP to an JSON string
   *
   * @return JSON string
   */
