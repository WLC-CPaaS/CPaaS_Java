...
public class ServiceDocsCallparkGet {
  ...
  public ServiceDocsCallparkGet nextStartKey(@javax.annotation.Nullable String nextStartKey) {
  ...
  public ServiceDocsCallparkGet pageSize(@javax.annotation.Nullable Integer pageSize) {
  ...
  public ServiceDocsCallparkGet requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ServiceDocsCallparkGet startKey(@javax.annotation.Nullable String startKey) {
  ...
  public ServiceDocsCallparkGet statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceDocsCallparkGet serviceDocsCallparkGet = (ServiceDocsCallparkGet) o;
    return Objects.equals(this.data, serviceDocsCallparkGet.data) &&
        Objects.equals(this.nextStartKey, serviceDocsCallparkGet.nextStartKey) &&
        Objects.equals(this.pageSize, serviceDocsCallparkGet.pageSize) &&
        Objects.equals(this.requestId, serviceDocsCallparkGet.requestId) &&
        Objects.equals(this.startKey, serviceDocsCallparkGet.startKey) &&
        Objects.equals(this.statusCode, serviceDocsCallparkGet.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceDocsCallparkGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceDocsCallparkGet
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceDocsCallparkGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceDocsCallparkGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceDocsCallparkGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceDocsCallparkGet.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceDocsCallparkGet>() {
           @Override
           public void write(JsonWriter out, ServiceDocsCallparkGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceDocsCallparkGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceDocsCallparkGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceDocsCallparkGet
   * @throws IOException if the JSON string is invalid with respect to ServiceDocsCallparkGet
   */
  public static ServiceDocsCallparkGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceDocsCallparkGet.class);
  }

  /**
   * Convert an instance of ServiceDocsCallparkGet to an JSON string
   *
   * @return JSON string
   */
