...
public class ModelsDeviceOutputFullProvision {
  ...
  public ModelsDeviceOutputFullProvision endpointBrand(@javax.annotation.Nullable String endpointBrand) {
  ...
  public ModelsDeviceOutputFullProvision endpointFamily(@javax.annotation.Nullable String endpointFamily) {
  ...
  public ModelsDeviceOutputFullProvision endpointModel(@javax.annotation.Nullable String endpointModel) {
  ...
  public ModelsDeviceOutputFullProvision id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsDeviceOutputFullProvision
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsDeviceOutputFullProvision.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsDeviceOutputFullProvision is not found in the empty JSON string", ModelsDeviceOutputFullProvision.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsDeviceOutputFullProvision.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsDeviceOutputFullProvision` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsDeviceOutputFullProvision.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsDeviceOutputFullProvision' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsDeviceOutputFullProvision> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsDeviceOutputFullProvision.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsDeviceOutputFullProvision>() {
           @Override
           public void write(JsonWriter out, ModelsDeviceOutputFullProvision value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsDeviceOutputFullProvision read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsDeviceOutputFullProvision given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsDeviceOutputFullProvision
   * @throws IOException if the JSON string is invalid with respect to ModelsDeviceOutputFullProvision
   */
  public static ModelsDeviceOutputFullProvision fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsDeviceOutputFullProvision.class);
  }

  /**
   * Convert an instance of ModelsDeviceOutputFullProvision to an JSON string
   *
   * @return JSON string
   */
